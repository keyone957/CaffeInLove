...
namespace Game
{
    public class Command_Name : Command
    {
        ...
        public override void Do() => GameSystem._Instance._UI._Dialogue.SetName(_Name);
    ...
    public class Command_Text : Command
    {
        ...
        public override void Do() => GameSystem._Instance._UI._Dialogue.SetText(_Text);
    ...
    public class Command_HideText : Command
    {
        ...
        public override void Do() => GameSystem._Instance._UI._Dialogue.SetActivate(false);
